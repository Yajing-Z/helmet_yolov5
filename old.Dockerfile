...
EXPOSE 8080 8081
ENV PYTHONPATH "${PYTHONPATH}:/home/model-server/resources/helmet_yolov5/"
RUN python /home/model-server/resources/helmet_yolov5/export.py --weights /home/model-server/resources/helmet.pt --img 640 --batch 1
...
# --extra-files /home/model-server/resources/index_to_name.json
